...
%type <formals> 	formal_list formal_list_wrap
%type <formal>		formal
%type <cases>		case_list
%type <case_>		case
%type <expressions> expr_list expr_list_wrap expr_block
...
formal_list_wrap:	/* empty */				{ $$ = nil_Formals(); }
				|	formal_list 			{ $$ = $1; }
				;


feature :	OBJECTID '(' formal_list_wrap ')' ':' TYPEID '{' expr '}'
				{ $$ = method($1, $3, $6, $8); }
		|	OBJECTID ':' TYPEID assign		{ $$ = attr($1, $3, $4); }
		;
...
let :	OBJECTID ':' TYPEID assign IN expr %prec NOT
			{ $$ = let($1, $3, $4, $6); }
...
expr_list_wrap	:	/* empty */ 			{ $$ = nil_Expressions(); }
				|	expr_list 				{ $$ = $1; }
				;
...
expr:	OBJECTID ASSIGN expr 			{ $$ = assign($1,$3); }
	...
	|	expr '@' TYPEID '.' OBJECTID '(' expr_list_wrap ')'
		{ $$ = static_dispatch($1, $3, $5, $7); }

	|	expr '.' OBJECTID '(' expr_list_wrap ')'
		{ $$ = dispatch($1,$3,$5); }

	|	OBJECTID '(' expr_list_wrap ')'
